    ...
    <Container>
      ...
      <PostBody>
        ...
        <section>
          ...
          <p>
            2018年4月、ヤフー株式会社に入社後、GYAO!傘下であるレビューサイトのYahoo!映画、番組表サイトのYahoo!テレビ、映像コンテンツ制作のYahoo!映像トピックス（クローズ）の3サービスに配属される。コーディング、映像デザイン、イラスト制作を担当。
            <br />
            2019年ごろから1年かけてYahoo!テレビのフルリニューアルプロジェクトに他業種と協業で取り組む。そのほか、CMS構築を含む特集サイトやバナー制作、SNS運用などを担当する。
            <br />
            2020年以降、GYAO!特集チームのデザイナーとして、ビジュアルデザイン・コーディングなど幅広く担当し、20を超える案件に携わる。
            <br />
            2021年、M-1グランプリの特集でのUX体験の向上やリスク対策への取り組みが評価され、GYAO!下期表彰式で部門賞を受賞。
            <br />
            2023年6月、ヤフーを退職、現在はフリーランスとして業務委託でデザインをおこなっている。
            <br />
            2024年2月、第一子出産。
          </p>
        </section>
